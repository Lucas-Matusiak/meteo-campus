<template>
  <div>
    <div id="chooseUniversity" class="fixed top-16 w-72">
      ...
      <Combobox v-model="selectedUniversity">
        <div class="relative mt-1">
          ...
          <TransitionRoot
            ...
            leaveTo="opacity-0"
            @after-leave="query = selectedUniversity"
          >
            <ComboboxOptions
            ...
            >
              <div
                v-if="
                  filteredList(listUniversities, query).length === 0 &&
                  query !== ''
                "
              ...
              <ComboboxOption
                v-for="university in filteredList(listUniversities, query)"
                as="template"
                :key="university"
                :value="university"
