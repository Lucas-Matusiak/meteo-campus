<template>
       <div class="flex pb-20">
              <div class = "pr-10 pt-5">
                  <img src="~/../assets/images/Humidite.svg" alt="Logo Humidité" class="logo" />
                  <h1 class ="text-2xl font-bold bg-clip-text pt-5 ">{{ humidite }}%</h1>
              ...
              <div class="wind-speed pl-4">
                  <img src="~/../assets/images/vent.svg" alt="Logo Vitesse du vent" class="logo" />
